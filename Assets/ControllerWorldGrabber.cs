...
public class ControllerWorldGrabber : MonoBehaviour
{
    ...
    ConfigurableJoint controllerAttachJoint;
    ...
    private void SnapObjectToGrabToController(GameObject obj)
    {
        ...
        //controllerAttachJoint = worldObj.AddComponent<FixedJoint>();
        controllerAttachJoint = obj.AddComponent<ConfigurableJoint>();
        controllerAttachJoint.xMotion = ConfigurableJointMotion.Locked;
        controllerAttachJoint.yMotion = ConfigurableJointMotion.Locked;
        controllerAttachJoint.zMotion = ConfigurableJointMotion.Locked;
